    ...
    <section className={`hubWorld ${debugMode ? "is-debug" : ""}`}>
      ...
      <div className="hubViewport" ref={viewportRef}>
        ...
        >
          ...
          {debugMode ? (
            <div
              className="hubPlayerCollisionBox"
              style={{
                left: playerCollisionBox.x,
                top: playerCollisionBox.y,
                width: playerCollisionBox.width,
                height: playerCollisionBox.height,
              }}
            >
              <span>player feet</span>
            </div>
          ) : null}
      ...
      {debugMode ? (
        <div className="hubDebugPanel">
          ...
          <span>Footbox: {Math.round(playerCollisionBox.width)}×{Math.round(playerCollisionBox.height)}</span>
        </div>
      ) : null}
